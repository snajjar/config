...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "g", function () awful.spawn("google-chrome-stable --ignore-gpu-blacklist") end,
              {description = "open google chrome", group = "launcher"}),
    awful.key({ modkey,           }, "e", function () awful.spawn("thunar") end,
              {description = "open thunar file explorer", group = "launcher"}),
    awful.key({ modkey,           }, "f", function () awful.spawn("firefox") end,
              {description = "open firefox", group = "launcher"}),
    awful.key({ modkey, "Control" }, "r", awesome.restart,
              {description = "reload awesome", group = "awesome"}),
    awful.key({ modkey,           }, "m", function () awful.spawn("mousepad") end,
